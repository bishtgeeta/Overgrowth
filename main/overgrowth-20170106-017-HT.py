...
inputFile = r'W:\geeta\Overgrowth\High Temperature\20170106-017\20170106-017.avi'
outputFile = r'W:\geeta\Overgrowth\High Temperature\20170106-017\20170106-017.h5'
inputDir = r'W:\geeta\Overgrowth\High Temperature\20170106-017'
outputDir = r'W:\geeta\Overgrowth\High Temperature\20170106-017\output'
pixInNM = 0.26345214
fps = 100
...
#areaRange = numpy.array([10000,25000], dtype='float64')
...
#for frame in tqdm(procFrameList[rank]):
    ...
    #bImg = imageProcess.binary_erosion(bImg, iterations=20)
    #bImg = imageProcess.binary_dilation(bImg, iterations=20)
